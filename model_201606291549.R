### 6/29-1:19pm Buidling a new model without other ambiguous factor in the dataset but with NA
rm(list = ls())
library(h2o)
...
#########another dataset omiting NAs
#try it after the 1st model run
...
#GBM_learner       auc
#1   h2o.glm.8 0.8813289
#2   h2o.gbm.4 0.8985328
#3   h2o.gbm.5 0.8982905
#4   h2o.gbm.6 0.8991535
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission_no?_gbm2-6") #Public leadboard score is 0.
###########################################################################################################
