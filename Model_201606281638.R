...
#AUC expected
cvAUC::AUC(predictions = GBM_valpredictions, labels = labels) #0.891
...
#GBM_learner       auc
#1   h2o.gbm.3 0.8952834
#2   h2o.gbm.4 0.8988769
#3   h2o.gbm.5 0.9002026
#4   h2o.gbm.6 0.8995754
#5  h2o.gbm.18 0.8646129
#6  h2o.gbm.24 0.8456092
#7  h2o.gbm.25 0.8551518
#8  h2o.gbm.26 0.8405353
#9  h2o.gbm.28 0.8929885
########################################
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission-GBMlearner_w/newgbmL-11para") #Public leadboard score is 0.
############################################################################################################
