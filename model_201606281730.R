...
x11 = c("pri_cst","ethnct_ds_tx","dx_prspct_med_risk_qt","rx_prspct_ttl_risk_qt","mcare_prspct_med_risk_qt","loh_prspct_qt","cms_hcc_130_ct",
        "rx_inpat_prspct_ttl_risk_qt","cg_2014","cops2_qt","rx_prspct_ttl_risk_qt_p")
...
h2o.gbm.24 <- function(..., ntrees = 100, col_sample_rate = 0.8, max_depth = 30, seed = 214) h2o.gbm.wrapper(..., ntrees = ntrees, col_sample_rate = col_sample_rate, max_depth = max_depth, seed = seed)
h2o.gbm.25 <- function(..., ntrees = 100, col_sample_rate = 0.7,max_depth = 30, seed = 214) h2o.gbm.wrapper(..., ntrees = ntrees, col_sample_rate = col_sample_rate, max_depth = max_depth, seed = seed)
h2o.gbm.26 <- function(..., ntrees = 100, col_sample_rate = 0.6,max_depth = 30, seed = 214) h2o.gbm.wrapper(..., ntrees = ntrees, col_sample_rate = col_sample_rate, max_depth = max_depth, seed = seed)
h2o.gbm.28 <- function(..., ntrees = 100, col_sample_rate = 0.8, max_depth = 10, seed = 214) h2o.gbm.wrapper(..., ntrees = ntrees, col_sample_rate = col_sample_rate, max_depth = max_depth, seed = seed)
...
GBM_customfit <- h2o.ensemble(x = x11, y = y,
...
#AUC expected
cvAUC::AUC(predictions = GBM_valpredictions, labels = labels) #0.894

#GBM_learner       auc
#1    h2o.glm.1 0.8764571
#2    h2o.glm.2 0.8765767
#3    h2o.glm.3 0.8763866
#4    h2o.glm.4 0.8765767
#5    h2o.glm.5 0.8801591
#6    h2o.glm.6 0.8801591
#7    h2o.glm.7 0.8765767
#8    h2o.glm.8 0.8919399
#9    h2o.glm.9 0.8750158
#10  h2o.glm.10 0.8750158
#11   h2o.gbm.3 0.8956287
#12   h2o.gbm.4 0.8988769
#13   h2o.gbm.5 0.9002026
#14   h2o.gbm.6 0.8995754
#15  h2o.gbm.18 0.8640292
#16  h2o.gbm.24 0.8460748
#17  h2o.gbm.25 0.8531775
#18  h2o.gbm.26 0.8437916
#19  h2o.gbm.28 0.8933318
###############
###########################################################################
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission-GLMGBMlearner_11para") #Public leadboard score is 0.
############################################################################################################
