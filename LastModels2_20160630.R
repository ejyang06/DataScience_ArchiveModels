#6/30: Final Model Testing:
# With NA, no ambiguous factor like (X or ?)
#lastModel#2: Using all new learners with 9 var
...
#AUC expected
cvAUC::AUC(predictions = GBM_valpredictions, labels = labels) #0.9059349
###############
###########################################################################
...
#GBM_learner       auc
#1           h2o.glm.1 0.8891372
#2           h2o.glm.2 0.8899097
#3           h2o.glm.8 0.8926626
#4           h2o.glm.9 0.8926626
#5  h2o.randomForest.1 0.9062285
#6           h2o.gbm.2 0.9034006
#7           h2o.gbm.3 0.9022357
#8           h2o.gbm.4 0.9032333
#9           h2o.gbm.5 0.9036421
#10 h2o.deeplearning.5 0.8697028
#11 h2o.deeplearning.6 0.8586218
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission_lastmodel2") #Public leadboard score is 0.
###########################################################################################################
...
data.frame(GBM_learner, auc)
#GBM_learner       auc
#1           h2o.glm.1 0.8787933
#2           h2o.glm.2 0.8796059
#3           h2o.glm.8 0.8864846
#4           h2o.glm.9 0.8815141
#5  h2o.randomForest.1 0.8704869
#6           h2o.gbm.2 0.8965710
#7           h2o.gbm.3 0.8970784
#8           h2o.gbm.4 0.8968896
#9           h2o.gbm.5 0.8976395
#10 h2o.deeplearning.5 0.8528784
#11 h2o.deeplearning.6 0.8220072
