...
#AUC expected
cvAUC::AUC(predictions = GBM_valpredictions, labels = labels) #0.9013019

#GBM_learner       auc
#1    h2o.glm.8 0.8887579
#2    h2o.gbm.3 0.8962710
#3    h2o.gbm.4 0.9008085
#4    h2o.gbm.5 0.9001783
#5    h2o.gbm.6 0.9003554
#6   h2o.gbm.24 0.8965163
#7   h2o.gbm.25 0.8960369
#8   h2o.gbm.26 0.8970757
#9   h2o.gbm.28 0.8975866
#10  h2o.gbm.34 0.8975866
#11  h2o.gbm.35 0.8977036
#12  h2o.gbm.36 0.8989632
###############
###########################################################################
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission-1GL11MGBMlearner_12para") #Public leadboard score is 0.896xxx ( i submitte this one by mistake in choosing in 1 var)
###########################################################################################################