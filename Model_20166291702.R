### 6/29-2:50pm Buidling a new model without other ambiguous factor in the dataset and without NA
rm(list = ls())
library(h2o)
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission_noNA_1glm3gbm") #Public leadboard score is 0.
###########################################################################################################
