...
#lastModel#1: Using all new learners with 9 var
...
#AUC expected
cvAUC::AUC(predictions = GBM_valpredictions, labels = labels) #[1] 0.8738464
###############
###########################################################################
...
submitter(hutest$mbr_id,GBM_predictions,"husubmission_lastmodel1") #Public leadboard score is 0.
###########################################################################################################
#Model 2
GBM_learner <- c(
  #  "h2o.gbm.1"
